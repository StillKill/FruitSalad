...
- После истощения всех колод переходить в `refresh -> end_game` и замораживать итоговый snapshot игроков.
- Показывать overlay с победителем, местами и детализацией scoring для выбранного игрока.
