...
- Для верхней карты выбранной колоды доступна отдельная кнопка переворота в `backFruit`, а в области активного игрока можно выбрать один свой салат для переворота в текущем ходе.
