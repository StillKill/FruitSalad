...
- Removed standalone `Verification:` entries from `changes.md` and updated `AGENTS.md` plus `project.md` so the log stays a short record of completed work; verified by reviewing the markdown diff.
